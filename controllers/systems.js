...
exports.get = function (req, resp) {
    // airvantage.systems_query(),function (err, res) {
    //     if (err) {
    //         console.log("ERR with body: " + err);
    //     } else {
    //         console.log("systems query succeed");
    //         airvantage.data_query(),function (err, res) {
    //             if (err) {
    //                 console.log("ERR with body: " + err);
    //             } else {
    ...
    sensorhub.systems_query({headers: headers})(function (err, res) {
        if (err) {
            console.log("ERR with body: " + err);
        } else {            
            console.log("System query succeed");
            resp.render('systems', {});
        }
    });
